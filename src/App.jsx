...
const App = () => {
    ...
    const [showNoQuestionsError, setShowNoQuestionError] = React.useState(false)
    ...
    const handleNoQuestionsError = boolean => setShowNoQuestionError(boolean);
    ...
    return (
        <main>
                        ...
                        <div className="gameOptions-container">
                            <div className="select-container">
                                ...
                                >
                                    ...
                                    <option value="10">Entertainment: Boooks</option>
                                    ...
                                    <option value="31">Entertainment: Japanese Anime &amp; Animations</option>
            ...
            <footer>Developed by &nbsp;
                <a href="https://github.com/Harshavrdhana" target="_blank" rel="noreferrer">
                    Harshavardhana U N
                </a>
            </footer>
        </main>
